...
function calcularVelocidade(deslocamentoFinal, deslocamentoInicial, tempo) {
    ...
    let resolucaoVelocidade = `<p> Velocidade média = (Posição Final - Posição Inicial) / tempo <br> </p>
...
function calcularPosicaoInicial(deslocamentoFinal, velocidade, tempo) {
    ...
    let resolucaoPosicaoInicial = `<p> Posição inicial = Posição Final - (Velocidade * tempo) <br> </p>
            <p> Posição inicial = ${deslocamentoFinal} - (${velocidade} * ${tempo}) <br> </p>
            <p> Posição inicial = ${posicaoInicial} metros <br> </p>`;
...
function calcularPosicaoFinal(deslocamentoInicial, velocidade, tempo) {
    ...
    let resolucaoPosicaoFinal = `<p> Posição Final = Posição Inicial + (Velocidade * tempo) <br> </p>
            <p> Posição Final = ${deslocamentoInicial} + (${velocidade} * ${tempo}) <br> </p>
            <p> Posição Final = ${posicaoFinal} metros <br> </p>`;
...
function calcularTempo(deslocamentoFinal, deslocamentoInicial, velocidade) {
    ...
    let resolucaoTempo = `<p> Tempo = Posição Final - Posição Inicial / velocidade. <br></p>
            <p> Tempo = ${deslocamentoFinal} - ${deslocamentoInicial} / ${velocidade} <br> </p>
            <p> Tempo = ${tempo} segundos <br> </p>`;
...
/* função para retornar o alerta de campo não preenchido */
